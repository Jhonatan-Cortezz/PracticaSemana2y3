...
public class ListViewPoo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_view_poo);
        setTitle("ListView POO");

        tv1 = findViewById(R.id.largoP);
        lst = findViewById(R.id.listaP);
